...
export const STRINGS = {
  ...
  chartTitle: {
    ar: 'نسب التغير ومستويات الأسعار أسبوعيا للسلع الأساسية خلال شهر رمضان مقارنة بالأسعار الاسترشادية',
    en: 'Rates of change and weekly price levels for basic commodities during Ramadan compared to indicative prices',
  },

  // UI controls
  weekLabel: { ar: 'الأسبوع', en: 'Week' },
  productLabel: { ar: 'المنتج', en: 'Item' },
  selectProduct: { ar: 'اختيار السلعة', en: 'Select item' },
  priceChange: { ar: 'تغير السعر', en: 'Price change' },
  itemCount: { ar: 'عدد السلع', en: 'Items' },
  filterLabel: { ar: 'فلترة', en: 'Filter' },
  all: { ar: 'الكل', en: 'All' },
  ...
  // Card labels
  vsIndicative: { ar: 'عن الاسترشادي', en: 'vs indicative' },
  vsPreviousWeek: { ar: 'عن الأسبوع السابق', en: 'vs previous week' },
  indicativePrice: { ar: 'السعر الاسترشادي', en: 'Indicative price' },
  ...
  methodologyText: {
    ar:
`العنوان: حركة أسعار سلع أساسية مختارة خلال شهر رمضان المبارك
...
سلعة منخفضة أسعارها: تعني بأن السعر المرصود أقل من السعر الاسترشادي ويظهر نسبة تغير سلبية.`,
    ...
    en:
`Title: Price Movements of Selected Basic Commodities During the Holy Month "Ramadan"
