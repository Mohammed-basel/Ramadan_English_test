...
export function ProductCard({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap justify-center gap-2">
        ...
        >
          ...
          <span className={`${prevBadge.text}`}>
            {lang === 'en' ? 'vs. prev. week:' : 'عن الأسبوع السابق:'} {currentWeek === 1 ? '—' : formatSignedPercent(pctPrev, 1)}
          </span>
      ...
      {/* ✅ FOOTER */}
      <div className="flex justify-between items-center text-sm text-gray-600 pt-3 border-t border-gray-100 mt-4" style={{ textAlign: lang === 'en' ? 'left' : 'right' }}>
        <div>
